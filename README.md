...
- Данные об акциях **статические** — реальных бирж/внешних API котировок пока нет; акции управляются вручную через админ-эндпоинты.
- Часть разделов интерфейса (City Roof, Cryptocurrency, My Homes и др.) — заготовки-плейсхолдеры.
- Автотесты и CI на данный момент отсутствуют.
